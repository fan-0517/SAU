...
PLATFORM_CONFIGS = {
    ...
    "youtube": {
        ...
        "personal_url": "https://studio.youtube.com/channel/UC",
        "login_url": "https://accounts.google.com/ServiceLogin",
        "creator_video_url": "https://studio.youtube.com/channel/UC",
        "creator_image_url": "https://studio.youtube.com/channel/UC",
        "selectors": {
            "upload_button": [
                #1.导航上传页面的按钮
                '#upload-button > ytcp-button-shape > button > yt-touch-feedback-shape > div.yt-spec-touch-feedback-shape__fill',
                'xpath=/html/body/ytcp-app/ytcp-entity-page/div/div/main/div/ytcp-animatable[3]/ytcd-channel-dashboard/div[1]/div/ytcd-card-column[1]/ytcd-card/div/ytcd-basic-card/ytcd-item/ytcd-entity-snapshot-item/ytcd-video-snapshot-upload/div/div[3]/ytcp-upload-video-button/ytcp-button/ytcp-button-shape/button/yt-touch-feedback-shape/div[2]',
                #2.选择文件上传的按钮
                '#select-files-button > ytcp-button-shape > button > yt-touch-feedback-shape > div.yt-spec-touch-feedback-shape__fill',
                'xpath=/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-uploads-file-picker/div/ytcp-button/ytcp-button-shape/button/yt-touch-feedback-shape/div[2]'
            ],
            "publish_button": [
                #6.7.8.下一步的按钮
                '#next-button > ytcp-button-shape > button > yt-touch-feedback-shape > div.yt-spec-touch-feedback-shape__fill',
                'xpath=/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[2]/div/div[2]/ytcp-button[2]/ytcp-button-shape/button/yt-touch-feedback-shape/div[2]',
                #10publish按钮
                '#done-button > ytcp-button-shape > button > yt-touch-feedback-shape > div.yt-spec-touch-feedback-shape__fill',
                'xpath=/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[2]/div/div[2]/ytcp-button[3]/ytcp-button-shape/button/yt-touch-feedback-shape/div[2]'
                ],
            #3.标题编辑器选择器
            "title_editor": [
                '<div id="textbox" slot="input" contenteditable="true" role="textbox" tabindex="0" class="style-scope ytcp-social-suggestions-textbox" aria-disabled="false" aria-required="true" aria-label="Add a title that describes your video (type @ to mention a channel)" aria-invalid="true" style="display: inline-block;"></div>',
            ...
            #4.正文编辑器输入框选择器
            "textbox_selectors": [
                '<div id="textbox" slot="input" contenteditable="true" role="textbox" tabindex="0" class="style-scope ytcp-social-suggestions-textbox" aria-disabled="false" aria-required="false" aria-label="Tell viewers about your video (type @ to mention a channel)" aria-invalid="false" style="display: inline-block;"></div>',
            ...
            "thumbnail_button": [
                ...
                '//span[contains(text(), "Custom thumbnail")]',
                '//span[contains(text(), "自定义缩略图")]'
            ],
            "thumbnail_finish": [
            ...
            "date_input": ['input[aria-label="Date"]'],
            "time_input": ['input[aria-label="Time"]'],
        },
        "features": {
            # 平台功能支持
            #是否跳过Cookie验证
