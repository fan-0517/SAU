...
class xhsImageUploader(object):
    ...
    def __init__(self, account_file, file_path, title, text, tags, publish_date):
        ...
        # URL constants
        self.url = "https://creator.xiaohongshu.com/publish/publish?from=homepage&target=image&openFilePicker=true"
    ...
    async def upload(self, playwright: Playwright) -> None:
        ...
        await page.goto(self.url, wait_until='domcontentloaded', timeout=self.timeout_60s)
